        ...
        with slim.arg_scope(bn_drp_scope(is_training=is_training,
            ...
            with slim.arg_scope([slim.conv2d, slim.max_pool2d, slim.avg_pool2d], stride = 1, padding = "SAME"):
                ...
                def transition_layer(net, out_nums, scope = "transition_layer"):
                    net = slim.conv2d(net, out_nums, [1,1])
                    net = slim.avg_pool2d(net, [3,3], stride = 2)
                    return net
                
                end_point = "Pre_block_layer"
                #224 x 224 x3
                net = slim.conv2d(images, 2*growth, [7,7], stride = 2, scope = end_point + "Conv2d_0a_7x7")
                net = slim.max_pool2d(net, [3,3], stride =2, scope = end_point + "Maxpool_0a_3x3")
                ...
                with slim.arg_scope(densenet_arg_scope()):
                    logits = slim.conv2d(net, num_classes = 200, [1,1], scope = "Logits")
